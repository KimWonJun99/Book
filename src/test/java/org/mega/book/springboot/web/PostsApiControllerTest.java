...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT) // 랜덤으로 포터 받음.
public class PostsApiControllerTest{
    ...
    public void Posts_등록된다() throws Exception{
        ...
        assertThat(responseEntity.getBody()).isGreaterThan(0L); // 0L -> 자료형이 Long이면서 값이 0
        */
